...
Share the outline when useful. Continue when the user's request already authorizes deck creation; ask only if the user requested an outline review gate or a consequential choice remains unresolved.
