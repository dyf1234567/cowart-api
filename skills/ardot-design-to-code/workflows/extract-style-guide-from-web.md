...
Use the current Browser/Chrome skill to inspect and capture the target website through its supported runtime. Save verification assets to a task-specific workspace directory when supported. Do not install a separate browser automation stack.
